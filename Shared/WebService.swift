...
class WebService {
  ...
  // MARK: Request Helpers
	func requestWithURLString(_ string: String) -> URLRequest? {
	...
	func executeRequest<ResponseType: Decodable>(_ requestPath:String, completion: @escaping (_ response: ResponseType?, _ error: NSError?) -> Void) {
